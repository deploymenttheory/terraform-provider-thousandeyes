...
page_title: "thousandeyes_tests_dns_server Data Source - ThousandEyes"
subcategory: ""
description: |-
  Get DNS Server test.
---

# thousandeyes_tests_dns_server (Data Source)
...
data "thousandeyes_tests_dns_server" "example" {
}
```
...
- `dns_servers` (Attributes Set) (see [below for nested schema](#nestedatt--dns_servers))
...
- `server_id` (String) Unique identifier of the DNS server.
- `server_name` (String) Fully qualified domain name (FQDN) of DNS server.
