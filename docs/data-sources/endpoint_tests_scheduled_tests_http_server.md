...
page_title: "thousandeyes_endpoint_tests_scheduled_tests_http_server Data Source - ThousandEyes"
subcategory: ""
description: |-
  Retrieves HTTP server endpoint scheduled test.
---

# thousandeyes_endpoint_tests_scheduled_tests_http_server (Data Source)
...
- `http_time_limit` (Number) Maximum amount of time in milliseconds the agents wait before a request times out.
...
- `verify_certificate` (Boolean) Flag indicating if a certificate should be verified.
