...
page_title: "thousandeyes_tests_page_load Data Source - ThousandEyes"
subcategory: ""
description: |-
  Get Page Load test.
---

# thousandeyes_tests_page_load (Data Source)
...
- `http_interval` (Number) HTTP test run interval. The interval between HTTP test runs in seconds cannot exceed the specified interval value and defaults to the same value as the interval if not set.
