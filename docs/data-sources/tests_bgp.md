...
page_title: "thousandeyes_tests_bgp Data Source - ThousandEyes"
subcategory: ""
description: |-
  Get BGP test.
---

# thousandeyes_tests_bgp (Data Source)
...
data "thousandeyes_tests_bgp" "example" {
}
```
...
- `alert_rules` (Attributes Set) A list of enabled alert rule objects. (see [below for nested schema](#nestedatt--alert_rules))
