...
- `collect_proxy_network_data` (Boolean) Indicates whether network data to the proxy should be collected. <!-- probed:7.0.98-t1785744687658 --> Observed: the API assigns false when this is omitted. <!-- /probed -->
...
- `desired_status_code` (String) Specify the HTTP status code value that indicates a successful response. The default value accepts any 2xx or 3xx status code. <!-- probed:7.0.98-t1785758268502 --> Neither the update response nor a read returns this field: it is write-only in practice, and state carries the configured value. <!-- /probed -->
- `distributed_tracing` (Boolean) Adds distributed tracing headers to API requests using B3 and W3C standards. <!-- probed:7.0.98-t1785744687658 --> Observed: the API assigns false when this is omitted. <!-- /probed -->
...
- `enabled` (Boolean) Test is enabled. <!-- probed:7.0.98-t1785744687658 --> Observed: the API assigns true when this is omitted. <!-- /probed -->
- `fixed_packet_rate` (Number) Sets packets rate sent to measure the network in packets per second. <!-- probed:7.0.98-t1785758268502 --> Neither the update response nor a read returns this field: it is write-only in practice, and state carries the configured value. <!-- /probed -->
- `follow_redirects` (Boolean) To disable following HTTP/301 or HTTP/302 redirect directives, set this parameter to `false`. <!-- probed:7.0.98-t1785744687658 --> Observed: the API assigns true when this is omitted. <!-- /probed -->
...
- `include_headers` (Boolean) Set to `true` to capture response headers for objects loaded by the test. <!-- probed:7.0.98-t1785758268502 --> Neither the update response nor a read returns this field: it is write-only in practice, and state carries the configured value. <!-- /probed -->
- `interval` (Number) Interval between test runs in seconds. <!-- probed:7.0.98-t1785744687658 --> The API enforces this field's presence, which the specification does not declare. <!-- /probed -->
...
- `url` (String) Target for the test. <!-- probed:7.0.98-t1785744687658 --> The API enforces this field's presence, which the specification does not declare. <!-- /probed -->
...
- `use_public_bgp` (Boolean) Indicate if all available public BGP monitors should be used, when ommited defaults to `bgpMeasurements` value. <!-- probed:7.0.98-t1785744687658 --> Observed: the API assigns true when this is omitted. <!-- /probed -->
- `user_agent` (String) User-agent string to be provided during the test. <!-- probed:7.0.98-t1785758268502 --> Neither the update response nor a read returns this field: it is write-only in practice, and state carries the configured value. <!-- /probed -->
