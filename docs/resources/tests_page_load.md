...
- `interval` (Number) Interval between test runs in seconds. <!-- probed:7.0.98-t1785745161014 --> The API enforces this field's presence, which the specification does not declare. <!-- /probed -->
...
- `url` (String) Target for the test. <!-- probed:7.0.98-t1785745161014 --> The API enforces this field's presence, which the specification does not declare. <!-- /probed -->
