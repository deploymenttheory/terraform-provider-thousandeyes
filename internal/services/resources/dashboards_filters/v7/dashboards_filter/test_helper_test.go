...
// DashboardsFilterTestResource answers whether a thousandeyes_dashboards_filter is really in the API.
//
...
type DashboardsFilterTestResource struct{}
...
func (DashboardsFilterTestResource) Exists(
	ctx context.Context,
