...
// Create provisions a new thousandeyes_endpoint_tests_scheduled_tests_http_server.
func (r *EndpointTestsScheduledTestsHTTPServerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan EndpointTestsScheduledTestsHTTPServerResourceModel
	...
	created, err := r.client.Endpoint().Tests().ScheduledTests().HttpServer().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_endpoint_tests_scheduled_tests_http_server state from the API.
func (r *EndpointTestsScheduledTestsHTTPServerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state EndpointTestsScheduledTestsHTTPServerResourceModel
...
// readState fetches thousandeyes_endpoint_tests_scheduled_tests_http_server and maps it onto state.
//
...
func (r *EndpointTestsScheduledTestsHTTPServerResource) readState(
	ctx context.Context,
	state *EndpointTestsScheduledTestsHTTPServerResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Endpoint().Tests().ScheduledTests().HttpServer().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *EndpointTestsScheduledTestsHTTPServerResource) readAfterWrite(
	ctx context.Context,
	state *EndpointTestsScheduledTestsHTTPServerResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_endpoint_tests_scheduled_tests_http_server.
func (r *EndpointTestsScheduledTestsHTTPServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state EndpointTestsScheduledTestsHTTPServerResourceModel
	...
	_, err := r.client.Endpoint().Tests().ScheduledTests().HttpServer().ByTestId(state.ID.ValueString()).Patch(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_endpoint_tests_scheduled_tests_http_server.
func (r *EndpointTestsScheduledTestsHTTPServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state EndpointTestsScheduledTestsHTTPServerResourceModel
	...
	err := r.client.Endpoint().Tests().ScheduledTests().HttpServer().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
