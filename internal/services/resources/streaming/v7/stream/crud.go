...
// Create provisions a new thousandeyes_stream.
func (r *StreamResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, err := r.client.Streams().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_stream state from the API.
...
// readState fetches thousandeyes_stream and maps it onto state.
//
...
func (r *StreamResource) readState(
	ctx context.Context,
	...
	remote, err := r.client.Streams().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *StreamResource) readAfterWrite(
	ctx context.Context,
	state *StreamResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_stream.
func (r *StreamResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, err := r.client.Streams().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_stream.
func (r *StreamResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Streams().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
