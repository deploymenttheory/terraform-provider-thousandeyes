...
// Create provisions a new thousandeyes_tests_api.
func (r *TestsAPIResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan TestsAPIResourceModel
	...
	created, err := r.client.Tests().Api().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_tests_api state from the API.
func (r *TestsAPIResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state TestsAPIResourceModel
...
// readState fetches thousandeyes_tests_api and maps it onto state.
//
...
func (r *TestsAPIResource) readState(
	ctx context.Context,
	state *TestsAPIResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Tests().Api().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *TestsAPIResource) readAfterWrite(
	ctx context.Context,
	state *TestsAPIResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_tests_api.
func (r *TestsAPIResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state TestsAPIResourceModel
	...
	_, err := r.client.Tests().Api().ByTestId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_tests_api.
func (r *TestsAPIResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state TestsAPIResourceModel
	...
	err := r.client.Tests().Api().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
