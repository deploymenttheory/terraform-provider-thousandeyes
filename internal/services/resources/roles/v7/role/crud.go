...
func (r *RoleResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, err := r.client.Roles().Post(ctx, body, nil)
	if err != nil {
	...
	// record of.
	plan.ID = convert.PtrStringToFramework(created.GetRoleId())
...
func (r *RoleResource) readState(
	...
	remote, err := r.client.Roles().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *RoleResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, err := r.client.Roles().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
func (r *RoleResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Roles().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
