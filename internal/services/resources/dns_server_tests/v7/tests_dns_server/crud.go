...
// Create provisions a new thousandeyes_tests_dns_server.
func (r *TestsDNSServerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan TestsDNSServerResourceModel
	...
	created, err := r.client.Tests().DnsServer().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_tests_dns_server state from the API.
func (r *TestsDNSServerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state TestsDNSServerResourceModel
...
// readState fetches thousandeyes_tests_dns_server and maps it onto state.
//
...
func (r *TestsDNSServerResource) readState(
	ctx context.Context,
	state *TestsDNSServerResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Tests().DnsServer().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *TestsDNSServerResource) readAfterWrite(
	ctx context.Context,
	state *TestsDNSServerResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_tests_dns_server.
func (r *TestsDNSServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state TestsDNSServerResourceModel
	...
	_, err := r.client.Tests().DnsServer().ByTestId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_tests_dns_server.
func (r *TestsDNSServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state TestsDNSServerResourceModel
	...
	err := r.client.Tests().DnsServer().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
