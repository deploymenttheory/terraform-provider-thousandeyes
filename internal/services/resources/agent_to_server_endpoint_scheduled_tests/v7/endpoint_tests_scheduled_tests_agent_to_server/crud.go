...
// Create provisions a new thousandeyes_endpoint_tests_scheduled_tests_agent_to_server.
func (r *EndpointTestsScheduledTestsAgentToServerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan EndpointTestsScheduledTestsAgentToServerResourceModel
	...
	created, err := r.client.Endpoint().Tests().ScheduledTests().AgentToServer().Post(ctx, body, nil)
	if err != nil {
	...
	// record of.
	plan.ID = convert.PtrStringToFramework(created.GetTestId())
...
// Read refreshes thousandeyes_endpoint_tests_scheduled_tests_agent_to_server state from the API.
func (r *EndpointTestsScheduledTestsAgentToServerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state EndpointTestsScheduledTestsAgentToServerResourceModel
...
// readState fetches thousandeyes_endpoint_tests_scheduled_tests_agent_to_server and maps it onto state.
//
...
func (r *EndpointTestsScheduledTestsAgentToServerResource) readState(
	ctx context.Context,
	state *EndpointTestsScheduledTestsAgentToServerResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Endpoint().Tests().ScheduledTests().AgentToServer().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *EndpointTestsScheduledTestsAgentToServerResource) readAfterWrite(
	ctx context.Context,
	state *EndpointTestsScheduledTestsAgentToServerResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_endpoint_tests_scheduled_tests_agent_to_server.
func (r *EndpointTestsScheduledTestsAgentToServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state EndpointTestsScheduledTestsAgentToServerResourceModel
	...
	_, err := r.client.Endpoint().Tests().ScheduledTests().AgentToServer().ByTestId(state.ID.ValueString()).Patch(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_endpoint_tests_scheduled_tests_agent_to_server.
func (r *EndpointTestsScheduledTestsAgentToServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state EndpointTestsScheduledTestsAgentToServerResourceModel
	...
	err := r.client.Endpoint().Tests().ScheduledTests().AgentToServer().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
