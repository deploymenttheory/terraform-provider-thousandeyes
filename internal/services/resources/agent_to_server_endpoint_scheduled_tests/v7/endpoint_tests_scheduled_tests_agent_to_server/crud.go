...
// Create provisions a new thousandeyes_endpoint_tests_agent_to_server.
...
// Read refreshes thousandeyes_endpoint_tests_agent_to_server state from the API.
...
// readState fetches thousandeyes_endpoint_tests_agent_to_server and maps it onto state.
//
...
// Update applies configuration changes to an existing thousandeyes_endpoint_tests_agent_to_server.
...
// Delete removes a thousandeyes_endpoint_tests_agent_to_server.
