...
// Create provisions a new thousandeyes_tests_web_transaction.
func (r *TestsWebTransactionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan TestsWebTransactionResourceModel
	...
	created, err := r.client.Tests().WebTransactions().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_tests_web_transaction state from the API.
func (r *TestsWebTransactionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state TestsWebTransactionResourceModel
...
// readState fetches thousandeyes_tests_web_transaction and maps it onto state.
//
...
func (r *TestsWebTransactionResource) readState(
	ctx context.Context,
	state *TestsWebTransactionResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Tests().WebTransactions().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *TestsWebTransactionResource) readAfterWrite(
	ctx context.Context,
	state *TestsWebTransactionResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_tests_web_transaction.
func (r *TestsWebTransactionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state TestsWebTransactionResourceModel
	...
	_, err := r.client.Tests().WebTransactions().ByTestId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_tests_web_transaction.
func (r *TestsWebTransactionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state TestsWebTransactionResourceModel
	...
	err := r.client.Tests().WebTransactions().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
