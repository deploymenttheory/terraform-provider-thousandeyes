...
// Create provisions a new thousandeyes_tests_dnssec.
func (r *TestsDNSSECResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan TestsDNSSECResourceModel
	...
	created, err := r.client.Tests().Dnssec().Post(ctx, body, nil)
	if err != nil {
...
func (r *TestsDNSSECResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state TestsDNSSECResourceModel
...
// readState fetches thousandeyes_tests_dnssec and maps it onto state.
//
...
func (r *TestsDNSSECResource) readState(
	ctx context.Context,
	state *TestsDNSSECResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Tests().Dnssec().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *TestsDNSSECResource) readAfterWrite(
	ctx context.Context,
	state *TestsDNSSECResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_tests_dnssec.
func (r *TestsDNSSECResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state TestsDNSSECResourceModel
	...
	_, err := r.client.Tests().Dnssec().ByTestId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_tests_dnssec.
func (r *TestsDNSSECResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state TestsDNSSECResourceModel
	...
	err := r.client.Tests().Dnssec().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
