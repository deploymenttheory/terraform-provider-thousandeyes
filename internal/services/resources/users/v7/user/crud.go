...
func (r *UserResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, err := r.client.Users().Post(ctx, body, nil)
	if err != nil {
	...
	// record of.
	plan.ID = convert.PtrStringToFramework(created.GetUid())
...
func (r *UserResource) readState(
	...
	remote, err := r.client.Users().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *UserResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, err := r.client.Users().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
func (r *UserResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Users().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
