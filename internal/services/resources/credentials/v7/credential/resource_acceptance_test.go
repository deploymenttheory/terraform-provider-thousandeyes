...
import (
	...
	"github.com/deploymenttheory/terraform-provider-thousandeyes/internal/services/resources/credentials/v7/credential"
)

// The resource under test, and the helper that asks the API whether it is really there.
const address = "thousandeyes_credential.test"

var testResource = credential.CredentialTestResource{}

// TestAccResourceCredential_01_Lifecycle exercises the whole lifecycle against a live API.
//
...
func TestAccResourceCredential_01_Lifecycle(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: destroy.CheckDestroyed(testResource, "thousandeyes_credential", 20*time.Second),
