...
// Create provisions a new thousandeyes_credential.
func (r *CredentialResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, err := r.client.Credentials().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_credential state from the API.
...
// readState fetches thousandeyes_credential and maps it onto state.
//
...
func (r *CredentialResource) readState(
	ctx context.Context,
	...
	remote, err := r.client.Credentials().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *CredentialResource) readAfterWrite(
	ctx context.Context,
	state *CredentialResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_credential.
func (r *CredentialResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, err := r.client.Credentials().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_credential.
func (r *CredentialResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Credentials().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
