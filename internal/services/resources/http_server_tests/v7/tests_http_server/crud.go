...
// Create provisions a new thousandeyes_tests_http_server.
func (r *TestsHTTPServerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan TestsHTTPServerResourceModel
	...
	created, err := r.client.Tests().HttpServer().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_tests_http_server state from the API.
func (r *TestsHTTPServerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state TestsHTTPServerResourceModel
...
// readState fetches thousandeyes_tests_http_server and maps it onto state.
//
...
func (r *TestsHTTPServerResource) readState(
	ctx context.Context,
	state *TestsHTTPServerResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Tests().HttpServer().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *TestsHTTPServerResource) readAfterWrite(
	ctx context.Context,
	state *TestsHTTPServerResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_tests_http_server.
func (r *TestsHTTPServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state TestsHTTPServerResourceModel
	...
	_, err := r.client.Tests().HttpServer().ByTestId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_tests_http_server.
func (r *TestsHTTPServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state TestsHTTPServerResourceModel
	...
	err := r.client.Tests().HttpServer().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
