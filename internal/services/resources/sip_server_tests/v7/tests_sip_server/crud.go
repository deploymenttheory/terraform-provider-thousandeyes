...
// Create provisions a new thousandeyes_tests_sip_server.
func (r *TestsSIPServerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan TestsSIPServerResourceModel
	...
	created, err := r.client.Tests().SipServer().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_tests_sip_server state from the API.
func (r *TestsSIPServerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state TestsSIPServerResourceModel
...
// readState fetches thousandeyes_tests_sip_server and maps it onto state.
//
...
func (r *TestsSIPServerResource) readState(
	ctx context.Context,
	state *TestsSIPServerResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Tests().SipServer().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *TestsSIPServerResource) readAfterWrite(
	ctx context.Context,
	state *TestsSIPServerResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_tests_sip_server.
func (r *TestsSIPServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state TestsSIPServerResourceModel
	...
	_, err := r.client.Tests().SipServer().ByTestId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_tests_sip_server.
func (r *TestsSIPServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state TestsSIPServerResourceModel
	...
	err := r.client.Tests().SipServer().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
