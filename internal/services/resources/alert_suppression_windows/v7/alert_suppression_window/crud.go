...
// Create provisions a new thousandeyes_alert_suppression_window.
func (r *AlertSuppressionWindowResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan AlertSuppressionWindowResourceModel
	...
	created, err := r.client.AlertSuppressionWindows().Post(ctx, body, nil)
	if err != nil {
	...
	// record of.
	plan.ID = convert.PtrStringToFramework(created.GetAlertSuppressionWindowId())
...
// Read refreshes thousandeyes_alert_suppression_window state from the API.
func (r *AlertSuppressionWindowResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state AlertSuppressionWindowResourceModel
...
// readState fetches thousandeyes_alert_suppression_window and maps it onto state.
//
...
func (r *AlertSuppressionWindowResource) readState(
	ctx context.Context,
	state *AlertSuppressionWindowResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.AlertSuppressionWindows().ByWindowId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *AlertSuppressionWindowResource) readAfterWrite(
	ctx context.Context,
	state *AlertSuppressionWindowResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_alert_suppression_window.
func (r *AlertSuppressionWindowResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state AlertSuppressionWindowResourceModel
	...
	_, err := r.client.AlertSuppressionWindows().ByWindowId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_alert_suppression_window.
func (r *AlertSuppressionWindowResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state AlertSuppressionWindowResourceModel
	...
	err := r.client.AlertSuppressionWindows().ByWindowId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
