...
// Create provisions a new thousandeyes_connectors_panorama.
func (r *ConnectorsPanoramaResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan ConnectorsPanoramaResourceModel
	...
	created, err := r.client.Connectors().Panorama().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_connectors_panorama state from the API.
func (r *ConnectorsPanoramaResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state ConnectorsPanoramaResourceModel
...
// readState fetches thousandeyes_connectors_panorama and maps it onto state.
//
...
func (r *ConnectorsPanoramaResource) readState(
	ctx context.Context,
	state *ConnectorsPanoramaResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Connectors().Panorama().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *ConnectorsPanoramaResource) readAfterWrite(
	ctx context.Context,
	state *ConnectorsPanoramaResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_connectors_panorama.
func (r *ConnectorsPanoramaResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state ConnectorsPanoramaResourceModel
	...
	_, err := r.client.Connectors().Panorama().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_connectors_panorama.
func (r *ConnectorsPanoramaResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state ConnectorsPanoramaResourceModel
	...
	err := r.client.Connectors().Panorama().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
