...
// Create provisions a new thousandeyes_tests_ftp_server.
func (r *TestsFTPServerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan TestsFTPServerResourceModel
	...
	created, err := r.client.Tests().FtpServer().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_tests_ftp_server state from the API.
func (r *TestsFTPServerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state TestsFTPServerResourceModel
...
// readState fetches thousandeyes_tests_ftp_server and maps it onto state.
//
...
func (r *TestsFTPServerResource) readState(
	ctx context.Context,
	state *TestsFTPServerResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Tests().FtpServer().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *TestsFTPServerResource) readAfterWrite(
	ctx context.Context,
	state *TestsFTPServerResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_tests_ftp_server.
func (r *TestsFTPServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state TestsFTPServerResourceModel
	...
	_, err := r.client.Tests().FtpServer().ByTestId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_tests_ftp_server.
func (r *TestsFTPServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state TestsFTPServerResourceModel
	...
	err := r.client.Tests().FtpServer().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
