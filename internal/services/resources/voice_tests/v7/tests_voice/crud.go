...
// Create provisions a new thousandeyes_tests_voice.
func (r *TestsVoiceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan TestsVoiceResourceModel
	...
	created, err := r.client.Tests().Voice().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_tests_voice state from the API.
func (r *TestsVoiceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state TestsVoiceResourceModel
...
// readState fetches thousandeyes_tests_voice and maps it onto state.
//
...
func (r *TestsVoiceResource) readState(
	ctx context.Context,
	state *TestsVoiceResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Tests().Voice().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *TestsVoiceResource) readAfterWrite(
	ctx context.Context,
	state *TestsVoiceResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_tests_voice.
func (r *TestsVoiceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state TestsVoiceResourceModel
	...
	_, err := r.client.Tests().Voice().ByTestId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_tests_voice.
func (r *TestsVoiceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state TestsVoiceResourceModel
	...
	err := r.client.Tests().Voice().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
