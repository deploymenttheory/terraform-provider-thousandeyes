...
// Create provisions a new thousandeyes_operations_webhook.
func (r *OperationsWebhookResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan OperationsWebhookResourceModel
	...
	created, err := r.client.Operations().Webhooks().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_operations_webhook state from the API.
func (r *OperationsWebhookResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state OperationsWebhookResourceModel
...
// readState fetches thousandeyes_operations_webhook and maps it onto state.
//
...
func (r *OperationsWebhookResource) readState(
	ctx context.Context,
	state *OperationsWebhookResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Operations().Webhooks().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *OperationsWebhookResource) readAfterWrite(
	ctx context.Context,
	state *OperationsWebhookResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_operations_webhook.
func (r *OperationsWebhookResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state OperationsWebhookResourceModel
	...
	_, err := r.client.Operations().Webhooks().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_operations_webhook.
func (r *OperationsWebhookResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state OperationsWebhookResourceModel
	...
	err := r.client.Operations().Webhooks().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
