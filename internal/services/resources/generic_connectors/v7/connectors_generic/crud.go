...
// Create provisions a new thousandeyes_connectors_generic.
func (r *ConnectorsGenericResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan ConnectorsGenericResourceModel
	...
	created, err := r.client.Connectors().Generic().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_connectors_generic state from the API.
func (r *ConnectorsGenericResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state ConnectorsGenericResourceModel
...
// readState fetches thousandeyes_connectors_generic and maps it onto state.
//
...
func (r *ConnectorsGenericResource) readState(
	ctx context.Context,
	state *ConnectorsGenericResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Connectors().Generic().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *ConnectorsGenericResource) readAfterWrite(
	ctx context.Context,
	state *ConnectorsGenericResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_connectors_generic.
func (r *ConnectorsGenericResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state ConnectorsGenericResourceModel
	...
	_, err := r.client.Connectors().Generic().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_connectors_generic.
func (r *ConnectorsGenericResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state ConnectorsGenericResourceModel
	...
	err := r.client.Connectors().Generic().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
