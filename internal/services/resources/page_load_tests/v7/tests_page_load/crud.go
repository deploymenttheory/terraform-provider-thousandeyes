...
// Create provisions a new thousandeyes_tests_page_load.
func (r *TestsPageLoadResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan TestsPageLoadResourceModel
	...
	created, err := r.client.Tests().PageLoad().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_tests_page_load state from the API.
func (r *TestsPageLoadResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state TestsPageLoadResourceModel
...
// readState fetches thousandeyes_tests_page_load and maps it onto state.
//
...
func (r *TestsPageLoadResource) readState(
	ctx context.Context,
	state *TestsPageLoadResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Tests().PageLoad().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *TestsPageLoadResource) readAfterWrite(
	ctx context.Context,
	state *TestsPageLoadResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_tests_page_load.
func (r *TestsPageLoadResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state TestsPageLoadResourceModel
	...
	_, err := r.client.Tests().PageLoad().ByTestId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_tests_page_load.
func (r *TestsPageLoadResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state TestsPageLoadResourceModel
	...
	err := r.client.Tests().PageLoad().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
