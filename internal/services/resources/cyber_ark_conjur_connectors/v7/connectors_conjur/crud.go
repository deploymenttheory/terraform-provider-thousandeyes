...
// Create provisions a new thousandeyes_connectors_conjur.
func (r *ConnectorsConjurResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan ConnectorsConjurResourceModel
	...
	created, err := r.client.Connectors().Conjur().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_connectors_conjur state from the API.
func (r *ConnectorsConjurResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state ConnectorsConjurResourceModel
...
// readState fetches thousandeyes_connectors_conjur and maps it onto state.
//
...
func (r *ConnectorsConjurResource) readState(
	ctx context.Context,
	state *ConnectorsConjurResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Connectors().Conjur().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *ConnectorsConjurResource) readAfterWrite(
	ctx context.Context,
	state *ConnectorsConjurResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_connectors_conjur.
func (r *ConnectorsConjurResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state ConnectorsConjurResourceModel
	...
	_, err := r.client.Connectors().Conjur().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_connectors_conjur.
func (r *ConnectorsConjurResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state ConnectorsConjurResourceModel
	...
	err := r.client.Connectors().Conjur().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
