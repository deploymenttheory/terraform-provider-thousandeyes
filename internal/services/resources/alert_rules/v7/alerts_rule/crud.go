...
// Create provisions a new thousandeyes_alerts_rule.
func (r *AlertsRuleResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan AlertsRuleResourceModel
...
// Read refreshes thousandeyes_alerts_rule state from the API.
func (r *AlertsRuleResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state AlertsRuleResourceModel
...
// readState fetches thousandeyes_alerts_rule and maps it onto state.
//
...
func (r *AlertsRuleResource) readState(
	ctx context.Context,
	state *AlertsRuleResourceModel,
	op errors.Operation,
...
func (r *AlertsRuleResource) readAfterWrite(
	ctx context.Context,
	state *AlertsRuleResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_alerts_rule.
func (r *AlertsRuleResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state AlertsRuleResourceModel
...
// Delete removes a thousandeyes_alerts_rule.
func (r *AlertsRuleResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state AlertsRuleResourceModel
