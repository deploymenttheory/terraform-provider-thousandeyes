...
// AlertsRuleTestResource answers whether a thousandeyes_alerts_rule is really in the API.
//
...
type AlertsRuleTestResource struct{}
...
func (AlertsRuleTestResource) Exists(
	ctx context.Context,
