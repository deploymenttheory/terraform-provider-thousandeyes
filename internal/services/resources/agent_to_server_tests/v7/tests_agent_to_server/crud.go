...
// Create provisions a new thousandeyes_tests_agent_to_server.
func (r *TestsAgentToServerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan TestsAgentToServerResourceModel
	...
	created, err := r.client.Tests().AgentToServer().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_tests_agent_to_server state from the API.
func (r *TestsAgentToServerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state TestsAgentToServerResourceModel
...
// readState fetches thousandeyes_tests_agent_to_server and maps it onto state.
//
...
func (r *TestsAgentToServerResource) readState(
	ctx context.Context,
	state *TestsAgentToServerResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Tests().AgentToServer().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *TestsAgentToServerResource) readAfterWrite(
	ctx context.Context,
	state *TestsAgentToServerResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
func (r *TestsAgentToServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError(
		"Update is not supported by the API",
		"Every change to thousandeyes_tests_agent_to_server forces replacement, so Terraform should never "+
			"have called Update. This is a bug in the provider; please report it.",
	)
}

// Delete removes a thousandeyes_tests_agent_to_server.
func (r *TestsAgentToServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state TestsAgentToServerResourceModel
	...
	err := r.client.Tests().AgentToServer().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
