...
// Update applies configuration changes to an existing thousandeyes_tests_agent_to_server.
func (r *TestsAgentToServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state TestsAgentToServerResourceModel
	...
	_, err := r.client.Tests().AgentToServer().ByTestId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
