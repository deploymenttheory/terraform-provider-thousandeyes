...
import (
	...
	"github.com/deploymenttheory/terraform-provider-thousandeyes/internal/services/resources/dns_trace_tests/v7/tests_dns_trace"
)

// The resource under test, and the helper that asks the API whether it is really there.
const address = "thousandeyes_tests_dns_trace.test"

var testResource = tests_dns_trace.TestsDNSTraceTestResource{}

// TestAccResourceTestsDNSTrace_01_Lifecycle exercises the whole lifecycle against a live API.
//
...
func TestAccResourceTestsDNSTrace_01_Lifecycle(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: destroy.CheckDestroyed(testResource, "thousandeyes_tests_dns_trace", 20*time.Second),
