...
// Create provisions a new thousandeyes_tests_dns_trace.
func (r *TestsDNSTraceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan TestsDNSTraceResourceModel
	...
	created, err := r.client.Tests().DnsTrace().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_tests_dns_trace state from the API.
func (r *TestsDNSTraceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state TestsDNSTraceResourceModel
...
// readState fetches thousandeyes_tests_dns_trace and maps it onto state.
//
...
func (r *TestsDNSTraceResource) readState(
	ctx context.Context,
	state *TestsDNSTraceResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Tests().DnsTrace().ByTestId(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *TestsDNSTraceResource) readAfterWrite(
	ctx context.Context,
	state *TestsDNSTraceResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_tests_dns_trace.
func (r *TestsDNSTraceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state TestsDNSTraceResourceModel
	...
	_, err := r.client.Tests().DnsTrace().ByTestId(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_tests_dns_trace.
func (r *TestsDNSTraceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state TestsDNSTraceResourceModel
	...
	err := r.client.Tests().DnsTrace().ByTestId(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
