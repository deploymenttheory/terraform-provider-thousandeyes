...
// Create provisions a new thousandeyes_operations_credential_vault.
func (r *OperationsCredentialVaultResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan OperationsCredentialVaultResourceModel
	...
	created, err := r.client.Operations().CredentialVault().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes thousandeyes_operations_credential_vault state from the API.
func (r *OperationsCredentialVaultResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state OperationsCredentialVaultResourceModel
...
// readState fetches thousandeyes_operations_credential_vault and maps it onto state.
//
...
func (r *OperationsCredentialVaultResource) readState(
	ctx context.Context,
	state *OperationsCredentialVaultResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.Operations().CredentialVault().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *OperationsCredentialVaultResource) readAfterWrite(
	ctx context.Context,
	state *OperationsCredentialVaultResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing thousandeyes_operations_credential_vault.
func (r *OperationsCredentialVaultResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state OperationsCredentialVaultResourceModel
	...
	_, err := r.client.Operations().CredentialVault().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a thousandeyes_operations_credential_vault.
func (r *OperationsCredentialVaultResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state OperationsCredentialVaultResourceModel
	...
	err := r.client.Operations().CredentialVault().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
