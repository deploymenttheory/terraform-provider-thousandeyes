...
//
// It is generated from the provider blueprint by `tfpfgen provider scaffold`, so a
// behaviour change belongs in the generator's shell templates rather than in an edit
// here. Generated CRUD bodies are a fixed skeleton that calls into here, which keeps
// the generated code short enough to read and puts the fiddly parts somewhere they
