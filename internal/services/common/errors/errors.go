...
// Mapping an API's failure modes onto messages a practitioner can act on is
// judgement rather than transcription, which is why that judgement lives in this
// one reviewable file -- and why a change to it belongs in the generator's shell
// templates, not in an edit here. Generated CRUD calls into it by name.
package errors
